...
_vehChoices = vehPlanes + vehAttackHelis + vehTransportAir;
...
_vehicle = [position _road, 0, _tipoVeh, _lado] call A3A_fnc_spawnVehicle;
...
_vehicleT=[position _road, 0,_tipoVeh, _lado] call A3A_fnc_spawnVehicle;
